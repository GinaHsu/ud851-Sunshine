...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView mRecyckerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        mRecyckerView = (RecyclerView) findViewById(R.id.recyclerview_forecast);
       ...
       mRecyckerView.setLayoutManager(layoutManager);
        ...
        mRecyckerView.setAdapter(mForecastAdapter);
    ...
    private void showWeatherDataView() {
        ...
        mRecyckerView.setVisibility(View.VISIBLE);
    }
    ...
    private void showErrorMessage() {
        ...
        mRecyckerView.setVisibility(View.INVISIBLE);
